    ...
    return (
        <View wrap={false} style={iStyle.wrapper}>
            <View style={iStyle.sRow1}>
                ...
                <View>
                    <Text style={iStyle.smallText}>Puhelin: {props.companyInfo.phone}</Text>
                    <Text style={iStyle.smallText}>Sähköposti: {props.companyInfo.email}</Text>
                </View>

                <View>
                    <Text style={iStyle.smallText}>
                        Y-tunnus: {props.companyInfo.businessId}
                    </Text>
                    <Text style={iStyle.smallText}>
                        ALV-tunnus: {props.companyInfo.companyVATNumber}
                    </Text>
                </View>
            </View>
            <View style={iStyle.sRow2}>
                <Text style={iStyle.sRow2Col1}>Saajan {"\n"} tilinumero
                    {"\n"}
            ...
            <View style={iStyle.sRow3}>
                <Text style={iStyle.sRow3Col1}>Saaja {"\n"} Mottagare</Text>
            ...
            <View style={iStyle.sRow4}>
                <Text style={iStyle.sRow4Col1}>Maksajan
                    nimi ja
                    osoite
                    {"\n"} Betalarens
                    namn och
            ...
            <View style={iStyle.sRow5}>
                <Text style={iStyle.sRow4Col1}>Allekirjoitus
                    Underskrift</Text>
            ...
            <View style={iStyle.sRow6}>
                ...
                <View style={iStyle.sRow6Col3}>
                    <View>
                        <Text style={iStyle.sRow6Col3Col1}>
                            Eräpäivä
                            {"\n"}
                            Förf.dag
                        </Text>
